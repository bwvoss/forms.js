(function() {
  describe('Form.Validator.Required', function() {
    ...
    requiredValidator = {};
    beforeEach(function() {
      return requiredValidator = new Form.Validator.Required;
    });
    it('returns false when a text field is required and value is blank', function() {
    ...
    return it('returns false when a radio button is required and the value is undefined', function() {
